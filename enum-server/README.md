...
- **New Registration**: ~0.01 EMC + network fee
- **Update**: 0.005 EMC + network fee
- **Renewal**: 0.005 EMC per 365 days
- **Delete**: Network fee only
...
### Resources
- Emercoin Wiki: https://emercoin.com/wiki
